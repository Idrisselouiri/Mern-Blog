...
const DashboardComp = () => {
  ...
  useEffect(() => {
    const fetchPostData = async () => {
      try {
        const data = await fetch(`/api/post/getPosts?limit=5`);
    ...
    const fetchUsersData = async () => {
      try {
        const data = await fetch(`/api/user/getUsers?limit=5`);
        const res = await data.json();
        if (res.success === false) {
          console.log(res.message);
          return;
    ...
    const fetchComments = async () => {
      try {
        const data = await fetch(`/api/comment/getComments?limit=5`);
        const res = await data.json();
        if (res.success === false) {
          console.log(res.message);
          return;
